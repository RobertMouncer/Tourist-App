...
var getAndRenderVisits = function(){
    ...
    localforage.iterate(function(value, key, iterationNumber) {
        ...
        listItem = listItem + "<a data-url=\"index.html#events?sessionId=" + iterationNumber + "\" href=\"index.html#events?sessionId=" + iterationNumber + "\">";
...
function submitVisit(){
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        localforage.setItem(dateTime, visit).then(function () {
